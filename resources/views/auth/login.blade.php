...
<head>
    ...
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, shrink-to-fit=no"
          name="viewport">
    <title>Masuk Akun &mdash; KASKU</title>
    ...
    <!-- CSS Libraries -->
    <link rel="stylesheet"
          href="{{ asset('assets/modules/bootstrap-social/bootstrap-social.css') }}">
                ...
                <div class="row">
                    <div
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label"
                                                   for="remember-me">Ingatkan Saya</label>
                                        </div>
                                    </div>
                        ...
                        <div class="simple-footer">
                            © <strong>KASKU</strong> 2026. Hak Cipta Dilindungi.
                        </div>
                    </div>
                </div>
            </div>
